...
export async function generateMetadata(props: { params: Promise<{ id: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ['gastroenterology', 'hepatology', service.title.toLowerCase(), 'medical services'],
  };
}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-white dark:from-emerald-950/20 dark:via-green-900/20 dark:to-gray-900">
      <div className="max-w-4xl mx-auto px-4 py-20">
        {/* Breadcrumb */}
        <div className="mb-8">
          <Link href="/services" className="flex items-center space-x-2 text-emerald-600 dark:text-emerald-400 hover:text-green-600 dark:hover:text-green-400 transition">
            <ArrowLeft size={20} />
        ...
        {/* Header */}
        <div className="mb-12">
          <div className="w-20 h-20 bg-gradient-to-br from-emerald-200 to-green-200 dark:from-emerald-700 dark:to-green-700 rounded-2xl flex items-center justify-center mb-6">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30 p-8 rounded-2xl mb-12 border border-emerald-200/50 dark:border-emerald-700/50">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Key Features & Procedures:</h3>
            ...
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-white mb-4">Why Choose Our Service:</h3>
        ...
        <div className="bg-gradient-to-r from-emerald-100 via-green-100 to-teal-100 dark:from-emerald-900/40 dark:via-green-900/40 dark:to-teal-900/40 p-8 rounded-2xl mb-12 border border-emerald-200/50 dark:border-emerald-700/50">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Contact us today to schedule a consultation for {service.title.toLowerCase()}.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="tel:+977015451000" className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white px-6 py-3 rounded-lg font-semibold transition shadow-lg flex items-center justify-center space-x-2">
              <Phone size={20} />
              <span>Call Now</span>
            </a>
            <a href="https://wa.me/9779765199777" target="_blank" rel="noopener noreferrer" className="border-2 border-emerald-500 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950 px-6 py-3 rounded-lg font-semibold transition flex items-center justify-center space-x-2">
          ...
          <div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {relatedServices.map((relatedService) => (
                <Link key={relatedService.id} href={`/services/${relatedService.id}`} className="bg-white dark:bg-gray-800 rounded-lg p-6 transition border border-emerald-200/50 hover:shadow-lg hover:shadow-emerald-200 dark:hover:shadow-emerald-900/50">
                  ...
                  <h3 className="font-bold text-gray-900 dark:text-white mb-3">{relatedService.title}</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">{relatedService.description}</p>
                  <span className="text-emerald-600 dark:text-emerald-400 font-semibold text-sm">Learn More</span>
                </Link>
              ))}
            </div>
          </div>
