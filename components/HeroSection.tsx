      ...
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            ...
            <a href="https://wa.me/9779765199777" target="_blank" rel="noopener noreferrer" className="border-2 border-emerald-500 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-950 px-8 py-3 rounded-lg flex items-center justify-center space-x-2 transition overflow-hidden">
